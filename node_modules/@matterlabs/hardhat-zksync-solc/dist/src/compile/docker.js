...
async function runZksolcContainer(docker, image, input) {
    const createOptions = {
        Tty: false,
        AttachStdin: true,
        OpenStdin: true,
